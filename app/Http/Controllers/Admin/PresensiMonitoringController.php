...
class PresensiMonitoringController extends Controller
{
    public function index(Request $request)
    {
        ...
        $shift = Shift::where('status_aktif', 1)->get();

        return view('admin.presensi.monitoring', compact(
            'presensi',
            'karyawan',
            'fakultas',
            'departemen',
    ...
    {
        $presensi = Presensi::with(['karyawan.departemen', 'karyawan.fakultas', 'karyawan.jabatan', 'shift'])
                            ->findOrFail($id);
