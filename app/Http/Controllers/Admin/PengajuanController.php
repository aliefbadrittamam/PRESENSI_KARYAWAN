...
class PengajuanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Query Izin
        $izinQuery = Izin::with(['karyawan.user', 'approvedBy'])
            ->orderBy('tanggal_pengajuan', 'desc');
        
        // Query Cuti
        $cutiQuery = Cuti::with(['karyawan.user', 'approvedBy'])
            ->orderBy('tanggal_pengajuan', 'desc');
    ...
    {
        $izin = Izin::with(['karyawan.user', 'karyawan.jabatan', 'karyawan.departemen', 'approvedBy'])
            ->findOrFail($id);
    ...
    {
        $cuti = Cuti::with(['karyawan.user', 'karyawan.jabatan', 'karyawan.departemen', 'approvedBy'])
            ->findOrFail($id);
    ...
    public function approveIzin(Request $request, $id)
    {
        try {
            ...
            return redirect()->route('admin.pengajuan.index')
                ->with('success', 'Pengajuan izin berhasil disetujui dan presensi telah dibuat.');
    ...
    public function approveCuti(Request $request, $id)
    {
        try {
            ...
            return redirect()->route('admin.pengajuan.index')
                ->with('success', 'Pengajuan cuti berhasil disetujui dan presensi telah dibuat.');
