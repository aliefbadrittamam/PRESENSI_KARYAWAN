                ...
                <form action="{{ route('admin.karyawan.index') }}" method="GET">
                    <div class="row g-2 align-items-end">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <label class="form-label text-white small mb-1">Pencarian</label>
                            <input type="text" 
                                   name="search" 
                        ...
                        <!-- Jabatan -->
                        <div class="col-md-2 col-sm-6">
                            <label class="form-label text-white small mb-1">Jabatan</label>
                            <select name="jabatan" class="form-select form-select-sm bg-dark text-white border-secondary">
                                <option value="">Semua</option>
                                @foreach($jabatanList as $jab)
                                    <option value="{{ $jab->id_jabatan }}" {{ request('jabatan') == $jab->id_jabatan ? 'selected' : '' }}>
                                        {{ $jab->nama_jabatan }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-2 col-sm-6">
                            ...
                            <select name="departemen" class="form-select form-select-sm bg-dark text-white border-secondary">
                                <option value="">Semua</option>
                        ...
                        <div class="col-md-2 col-sm-6">
                            ...
                            <select name="fakultas" class="form-select form-select-sm bg-dark text-white border-secondary">
                                <option value="">Semua</option>
                                @foreach($fakultasList as $fak)
                                    <option value="{{ $fak->id_fakultas }}" {{ request('fakultas') == $fak->id_fakultas ? 'selected' : '' }}>
                                        {{ $fak->nama_fakultas }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    @if(request()->hasAny(['search', 'status', 'jabatan', 'departemen', 'fakultas']))
                        <div class="mt-2">
