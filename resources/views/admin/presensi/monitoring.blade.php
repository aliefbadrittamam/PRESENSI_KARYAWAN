                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        @if($item->keterlambatan_menit > 0)
                                            <br><small class="badge badge-warning">+{{ $item->keterlambatan_menit }}m</small>
                                        @endif
                                    </td>
                                    <td class="text-center">
                                    ...
                                    <td class="text-center">
                                        @if($item->foto_masuk || $item->foto_keluar)
                                            <button class="btn btn-info btn-sm" onclick="showPhotos({{ json_encode($item) }})" title="Lihat Foto">
                            ...
                            @empty
                                <tr>
                                    <td colspan="10" class="text-center py-4">
                                        ...
                                        <span class="text-muted">Tidak ada data presensi</span>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
