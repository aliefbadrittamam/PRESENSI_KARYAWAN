                ...
                <div class="text-center">
                    @if($presensi->karyawan->foto)
                        <img class="profile-user-img img-fluid img-circle" 
                             src="{{ asset('storage/' . $presensi->karyawan->foto) }}" 
                             alt="Foto Karyawan"
                            ...
                            <div class="card-body text-center">
                                @if($presensi->foto_masuk)
                                    <img src="{{ asset('storage/' . $presensi->foto_masuk) }}" 
                                         ...
                                         onclick="showImageModal('{{ asset('storage/' . $presensi->foto_masuk) }}', 'Foto Masuk')">
                                    <p class="mt-2 mb-0">
                            ...
                            <div class="card-body text-center">
                                @if($presensi->foto_keluar)
                                    <img src="{{ asset('storage/' . $presensi->foto_keluar) }}" 
                                         ...
                                         alt="Foto Keluar"
                                         style="max-height: 300px; cursor: pointer;"
                                         onclick="showImageModal('{{ asset('storage/' . $presensi->foto_keluar) }}', 'Foto Keluar')">
                                    <p class="mt-2 mb-0">
                                        <small class="text-muted">
                                            <i class="fas fa-clock mr-1"></i>
