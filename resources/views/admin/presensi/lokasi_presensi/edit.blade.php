        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="{{ route('admin.lokasi-presensi.update', $lokasi->id_lokasi) }}" method="POST">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            name="nama_lokasi" value="{{ old('nama_lokasi', $lokasi->nama_lokasi) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('jenis_lokasi') is-invalid @enderror"
                                            ...
                                            <option value="kantor"
                                                {{ old('jenis_lokasi', $lokasi->jenis_lokasi) == 'kantor' ? 'selected' : '' }}>
                                                Kantor</option>
                                            <option value="gedung"
                                                {{ old('jenis_lokasi', $lokasi->jenis_lokasi) == 'gedung' ? 'selected' : '' }}>
                                                Gedung</option>
                                            <option value="laboratorium"
                                                {{ old('jenis_lokasi', $lokasi->jenis_lokasi) == 'laboratorium' ? 'selected' : '' }}>
                                                Laboratorium</option>
                                            <option value="lainnya"
                                                {{ old('jenis_lokasi', $lokasi->jenis_lokasi) == 'lainnya' ? 'selected' : '' }}>
                                                Lainnya</option>
                                        </select>
                                        @error('jenis_lokasi')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        ...
                                        <select class="form-control @error('id_fakultas') is-invalid @enderror"
                                            ...
                                            @foreach ($fakultasList as $fakultas)
                                                <option value="{{ $fakultas->id_fakultas }}"
                                                    {{ old('id_fakultas', $lokasi->id_fakultas) == $fakultas->id_fakultas ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('status_aktif') is-invalid @enderror"
                                            ...
                                            <option value="1"
                                                {{ old('status_aktif', $lokasi->status_aktif) == '1' ? 'selected' : '' }}>
                                                Aktif</option>
                                            <option value="0"
                                                {{ old('status_aktif', $lokasi->status_aktif) == '0' ? 'selected' : '' }}>
                                                Nonaktif</option>
                                        </select>
                                        @error('status_aktif')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.00000001"
                                            ...
                                            name="latitude" value="{{ old('latitude', $lokasi->latitude) }}" readonly
                                            required>
                                        @error('latitude')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.00000001"
                                            ...
                                            name="longitude" value="{{ old('longitude', $lokasi->longitude) }}" readonly
                                            required>
                                        @error('longitude')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('radius_meter', $lokasi->radius_meter) }}" min="10" max="5000"
                                            required>
                                        @error('radius_meter')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="time"
                                            ...
                                            value="{{ old('waktu_operasional_mulai', $lokasi->waktu_operasional_mulai ? date('H:i', strtotime($lokasi->waktu_operasional_mulai)) : '') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="time"
                                            ...
                                            value="{{ old('waktu_operasional_selesai', $lokasi->waktu_operasional_selesai ? date('H:i', strtotime($lokasi->waktu_operasional_selesai)) : '') }}">
