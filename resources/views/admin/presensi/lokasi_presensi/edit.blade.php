                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('jenis_lokasi') is-invalid @enderror"
                                            ...
                                            <option value="kantor" {{ old('jenis_lokasi', $lokasi->jenis_lokasi) == 'kantor' ? 'selected' : '' }}>
                                                Kantor</option>
                                            <option value="gedung" {{ old('jenis_lokasi', $lokasi->jenis_lokasi) == 'gedung' ? 'selected' : '' }}>
                                                Gedung</option>
                                            <option value="laboratorium"
                                                {{ old('jenis_lokasi', $lokasi->jenis_lokasi) == 'laboratorium' ? 'selected' : '' }}>Laboratorium
                                            </option>
                                            <option value="lainnya"
                                                {{ old('jenis_lokasi', $lokasi->jenis_lokasi) == 'lainnya' ? 'selected' : '' }}>Lainnya</option>
                                        </select>
                                        @error('jenis_lokasi')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('status_aktif') is-invalid @enderror"
                                            ...
                                            <option value="1" {{ old('status_aktif', $lokasi->status_aktif) == '1' ? 'selected' : '' }}>
                                                Aktif</option>
                                            <option value="0" {{ old('status_aktif', $lokasi->status_aktif) == '0' ? 'selected' : '' }}>
                                                Nonaktif</option>
                                        </select>
                                        @error('status_aktif')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="time"
                                            ...
                                            value="{{ old('waktu_operasional_mulai', $lokasi->waktu_operasional_mulai) }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="time"
                                            ...
                                            value="{{ old('waktu_operasional_selesai', $lokasi->waktu_operasional_selesai) }}">
