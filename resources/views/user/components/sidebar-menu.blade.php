{{-- File: resources/views/user/components/sidebar-menu.blade.php --}}
    ...
    <div class="offcanvas-body p-0">
        <div class="list-group list-group-flush">
            ...
            <a href="{{ route('izin.create') }}" 
               class="list-group-item list-group-item-action border-0 py-3 {{ request()->routeIs('izin.*') ? 'active' : '' }}">
                <i class="fas fa-clipboard-list me-3"></i>
                Ajukan Izin
            </a>
            
            <a href="{{ route('cuti.index') }}" 
               class="list-group-item list-group-item-action border-0 py-3 {{ request()->routeIs('cuti.*') ? 'active' : '' }}">
