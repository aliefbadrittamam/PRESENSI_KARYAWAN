        ...
        <div class="presensi-card">
            ...
            <div class="status-info-section">
                ...
                @if($presensiHariIni)
                    <div class="status-today">
                        <div class="row g-3">
                            <div class="col-6">
                                <div class="status-box {{ $presensiHariIni->jam_masuk ? 'status-done' : 'status-pending' }}">
                            ...
                            <div class="col-6">
                                <div class="status-box {{ $presensiHariIni->jam_keluar ? 'status-done' : 'status-pending' }}">
            ...
            <div class="camera-section mt-4">
                ...
                <div class="camera-controls mt-3">
                    ...
                    <button type="button" class="btn btn-secondary btn-lg w-100 mt-2" id="retakeBtn" style="display: none;">
