                ...
                <tbody>
                    @forelse($presensi as $item)
                        <tr>
                            ...
                            {{-- Tanggal --}}
                            <td><strong>{{ \Carbon\Carbon::parse($item->tanggal_presensi)->format('d/m/Y') }}</strong></td>

                            {{-- Shift --}}
                            <td><span class="badge bg-dark badge-modern">{{ $item->shift->kode_shift ?? '-' }}</span></td>
                            ...
                            <td>
                                <span class="badge bg-{{ 
                                    $item->status_verifikasi == 'verified' ? 'success' : 
                                    ($item->status_verifikasi == 'rejected' ? 'danger' : 'warning')
                                }} badge-modern">
