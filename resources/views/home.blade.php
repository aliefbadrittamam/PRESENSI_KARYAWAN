                            ...
                            <div class="card bg-success text-white border-0 mb-0">
                                <div class="card-body p-2">
                                    ...
                                    <div class="progress mt-2" style="height: 3px;">
                                        <div class="progress-bar bg-white" style="width: {{ $totalKaryawan > 0 ? ($hadirHariIni / $totalKaryawan * 100) : 0 }}%"></div>
                                    </div>
                                    <small class="d-block mt-1">{{ $totalKaryawan > 0 ? round($hadirHariIni / $totalKaryawan * 100, 1) : 0 }}%</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-6 col-lg-3">
                            <div class="card bg-warning text-white border-0 mb-0">
                                <div class="card-body p-2">
                                    ...
                                    <div class="progress mt-2" style="height: 3px;">
                                        <div class="progress-bar bg-white" style="width: {{ $totalKaryawan > 0 ? ($terlambatHariIni / $totalKaryawan * 100) : 0 }}%"></div>
                                    </div>
                                    <small class="d-block mt-1">{{ $totalKaryawan > 0 ? round($terlambatHariIni / $totalKaryawan * 100, 1) : 0 }}%</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-6 col-lg-3">
                            <div class="card bg-info text-white border-0 mb-0">
                                <div class="card-body p-2">
                                    ...
                                    <div class="progress mt-2" style="height: 3px;">
                                        <div class="progress-bar bg-white" style="width: {{ $totalKaryawan > 0 ? ($izinHariIni / $totalKaryawan * 100) : 0 }}%"></div>
                                    </div>
                                    <small class="d-block mt-1">{{ $totalKaryawan > 0 ? round($izinHariIni / $totalKaryawan * 100, 1) : 0 }}%</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-6 col-lg-3">
                            <div class="card bg-danger text-white border-0 mb-0">
                                <div class="card-body p-2">
                                    ...
                                    <div class="progress mt-2" style="height: 3px;">
                                        <div class="progress-bar bg-white" style="width: {{ $totalKaryawan > 0 ? ($alphaHariIni / $totalKaryawan * 100) : 0 }}%"></div>
                                    </div>
                                    <small class="d-block mt-1">{{ $totalKaryawan > 0 ? round($alphaHariIni / $totalKaryawan * 100, 1) : 0 }}%</small>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                @forelse($topTerlambat as $karyawan)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <span class="badge bg-warning text-dark">{{ $karyawan->total_terlambat }}x</span>
                                        </td>
                                        <td class="text-center">
                            ...
                            <tbody>
                                @forelse($latestPresensi as $presensi)
                                    <tr>
                                        ...
                                        <td class="text-white-50">{{ $presensi->karyawan->departemen->nama_departemen ?? '-' }}</td>
                                        <td class="text-white-50">{{ $presensi->karyawan->jabatan->nama_jabatan ?? '-' }}</td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            @elseif($presensi->status_kehadiran == 'terlambat')
                                                ...
                                                @if($presensi->keterlambatan_menit > 0)
                                                    <br><small class="text-muted">({{ $presensi->keterlambatan_menit }}m)</small>
                                                @endif
                                            ...
                                            @else
                                                <span class="badge bg-secondary">{{ ucfirst($presensi->status_kehadiran) }}</span>
                                            @endif
                                        </td>
                                        <td class="text-center">
...
$(document).ready(function() {
    ...
    new Chart(document.getElementById('departemenChart'), {
        ...
        options: {
            ...
            scales: {
                y: { beginAtZero: true, ticks: { stepSize: 1, color: '#fff' }, grid: { color: 'rgba(255, 255, 255, 0.1)' } },
