            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    <span class="dropdown-item dropdown-header text-center">
                        <div class="image">
                            <img src="https://github.com/mdo.png" alt="User Avatar" class="img-size-50 img-circle mr-3">
                        </div>
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    <!-- Dashboard -->
                    <li class="nav-item">
                        <a href="{{ route('home') }}" class="nav-link {{ Request::is('home') || Request::is('dashboard') ? 'active' : '' }}">
                    ...
                    <!-- Master Data -->
                    <li class="nav-item {{ Request::is('fakultas*', 'departemen*', 'jabatan*', 'karyawan*') ? 'menu-open' : '' }}">
                        <a href="#" class="nav-link {{ Request::is('fakultas*', 'departemen*', 'jabatan*', 'karyawan*') ? 'active' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('presensi.create') }}" class="nav-link">
                                    <i class="nav-icon fas fa-sign-in-alt text-success"></i>
                                    <p>Presensi Masuk</p>
                                </a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('presensi.rekap') }}" class="nav-link {{ Request::is('presensi/rekap') ? 'active' : '' }}">
                    ...
                    <li class="nav-item {{ Request::is('shift*', 'lokasi*') ? 'menu-open' : '' }}">
                        <a href="#" class="nav-link {{ Request::is('shift*', 'lokasi*') ? 'active' : '' }}">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', function(e) {
            $('.dropdown-menu').each(function() {
                ...
                if (!$(this).is(e.target) && $(this).has(e.target).length === 0 && $('.dropdown-toggle').has(e.target).length === 0) {
