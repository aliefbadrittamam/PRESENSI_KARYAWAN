...
Route::middleware(['auth'])
    ...
    ->group(function () {
        ...
        Route::prefix('lokasi-presensi')
            ...
            ->group(function () {
                // List
                Route::get('/', [App\Http\Controllers\Admin\LokasiPresensiController::class, 'index'])->name('index');

                // Create
                Route::get('/create', [App\Http\Controllers\Admin\LokasiPresensiController::class, 'create'])->name('create');
                Route::post('/', [App\Http\Controllers\Admin\LokasiPresensiController::class, 'store'])->name('store');

                // Edit
                Route::get('/{id}/edit', [App\Http\Controllers\Admin\LokasiPresensiController::class, 'edit'])->name('edit');
                Route::put('/{id}', [App\Http\Controllers\Admin\LokasiPresensiController::class, 'update'])->name('update');

                // Show
                Route::get('/{id}', [App\Http\Controllers\Admin\LokasiPresensiController::class, 'show'])->name('show');

                // Delete
                Route::delete('/{id}', [App\Http\Controllers\Admin\LokasiPresensiController::class, 'destroy'])->name('destroy');

                // Get coordinates (AJAX)
                Route::post('/get-coordinates', [App\Http\Controllers\Admin\LokasiPresensiController::class, 'getCoordinates'])->name('get-coordinates');
            });
    });
